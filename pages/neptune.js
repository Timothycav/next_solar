...
const Items = () => {
 ...
 const myMouseOver = () => {
  ...
  return (
    ...
    <Image src="/images/planet-neptune.svg" alt="venus" className={styles.mainEarth}  width={380} height={380} /> 
    <Image src="/images/planet-neptune-internal.svg" alt="venus" className={`${styles.inpix} ${styles.hide}`}  width={380} height={380} /> 
    <Image src="/images/geology-neptune.png" alt="venus" className={`${styles.geopix} ${styles.hide}`}  width={380} height={380} />
      <div className={styles.grid_side}>
        <div className={styles.side_text}>
       <h1 className={styles.earth_text}>Neptune</h1>
       
       
        {data.length >= 2 && <p  className={styles.over } >{data[7].overview.content}</p>}
        {data.length >= 2 && <p className={`${styles.inter} ${styles.hide}`}>{data[7].structure.content}</p>}
        {data.length >= 2 && <p  className={`${styles.surface} ${styles.hide}`}>{data[7].geology.content}</p>}
  ...
  <div className={styles.box_two}>
    <div className={styles.box_two__content}>
      ...
      {data.length >= 2 && data[7].revolution}
      </div>
    </div>
  </div>
  ...
  <div className={styles.box_four}>
    <div className={styles.box_four__content}>
      ...
      {data.length >= 2 && data[7].temperature}
      </div>
    </div>
