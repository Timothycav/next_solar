...
const Items = () => {
 ...
 const myMouseOver = () => {
  ...
  return (
    ...
    <Image src="/images/planet-jupiter.svg" alt="venus" className={styles.mainEarth}  width={380} height={380} /> 
    <Image src="/images/planet-jupiter-internal.svg" alt="venus" className={`${styles.inpix} ${styles.hide}`}  width={380} height={380} /> 
    <Image src="/images/geology-jupiter.png" alt="venus" className={`${styles.geopix} ${styles.hide}`}  width={380} height={380} />
      <div className={styles.grid_side}>
        <div className={styles.side_text}>
       <h1 className={styles.earth_text}>Jupiter</h1>
  ...
  <div className={styles.box_two}>
    <div className={styles.box_two__content}>
      ...
      {data.length >= 2 && data[4].revolution}
      </div>
    </div>
  </div>
  ...
  <div className={styles.box_four}>
    <div className={styles.box_four__content}>
      ...
      {data.length >= 2 && data[4].temperature}
      </div>
    </div>
